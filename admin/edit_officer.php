    ...
    <div class="container">
                ...
                <div class="row uniform 50%">
                    ...
                    <div class="12u$">
                        ...
                        <select name="officer-year" id="officer-year">
                            ...
                            require($toRoot.'includes/mysqli_connect.php');
                            $years = [];
                            $sql = "SELECT officer_year FROM officers GROUP BY officer_year ORDER BY officer_year DESC";
                            $result = $conn->query($sql);
                            if ($result->num_rows > 0) {
                                // output data of each row
                                // $roles = $result->fetch_assoc();
        ...
        function editOfficer(){
            ...
            if (count($errors) == 0) {
                ...
                description = '$description', image = '$image', officer_year = '$officer_year', isExec = '$isExec', isAdvisor = '$isAd' 
                WHERE id=$officerId";
